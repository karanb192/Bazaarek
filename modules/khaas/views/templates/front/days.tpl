<h1>{l s='Khaas Days' mod='khaas'}</h1>

<p>Every week on Khaas Days you can get heavy discount on select products. 90's prices are back!</p>
...
{if isset($products) && $products}
	...
	<!-- Products list -->
	<div {if isset($id) && $id} id="{$id}"{/if} class="nomargin product_list {$LISTING_GRIG_MODE} row {if isset($class) && $class} {$class}{/if}">
